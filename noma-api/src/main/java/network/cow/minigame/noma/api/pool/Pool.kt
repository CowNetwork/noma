 ...
 */
abstract class Pool<PlayerType : Any, GameType : Game<PlayerType, GameType>, ItemType : Any>(protected val game: Game<PlayerType, GameType>, val config: PoolConfig<PlayerType, GameType>) {
